...
if (isset($_POST['submit']))
{
	...
	$sql="Insert into `files` (`file_name`,`path`,`upload_by`,`upload_date`,`status`,`file_type`) values ('$fileName','$path','$uploadBy','$uploadDate','active','$docType')";
	$dblink->query($sql) or
