...
if (isset($_POST['submit']))
{
	...
	{
		case "name":
			$sql="Select `file_name`,`upload_by`,`upload_date`,`file_id` from `files` where `file_name` like '%$searchString%'";
			break;
		case "uploadBy":
			$sql="Select `file_name`,`upload_by`,`upload_date`,`file_id` from `files` where `upload_by` like '%$searchString%'";
			break;
		case "uploadDate":
			$sql="Select `file_name`,`upload_by`,`upload_date`,`file_id` from `files` where `upload_by` like '%$searchString%'";
			break;
		case "all":
			$sql="Select `file_name`,`upload_by`,`upload_date`,`file_id` from `files`";
			break;
		default:
